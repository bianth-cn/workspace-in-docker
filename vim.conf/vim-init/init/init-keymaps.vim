...
function! ExecuteFile()
	...
	elseif &ft == 'python'
		...
		let cmd = 'time python "$(VIM_FILEPATH)"'
	elseif &ft == 'javascript'
		let cmd = 'time node "$(VIM_FILEPATH)"'
	elseif &ft == 'perl'
		let cmd = 'time perl "$(VIM_FILEPATH)"'
	elseif &ft == 'ruby'
		let cmd = 'time ruby "$(VIM_FILEPATH)"'
	elseif &ft == 'php'
		let cmd = 'time php "$(VIM_FILEPATH)"'
	elseif &ft == 'lua'
		let cmd = 'time lua "$(VIM_FILEPATH)"'
	elseif &ft == 'zsh'
		let cmd = 'time zsh "$(VIM_FILEPATH)"'
	elseif &ft == 'ps1'
		let cmd = 'time powershell -file "$(VIM_FILEPATH)"'
	elseif &ft == 'vbs'
		let cmd = 'time cscript -nologo "$(VIM_FILEPATH)"'
	elseif &ft == 'sh'
		let cmd = 'time bash "$(VIM_FILEPATH)"'
	elseif &ft == 'go'
        exec "!go build %<"
