...
if !exists("python_no_builtin_highlight")
  ...
  syn match   pythonAttribute	/\.\h\w*/hs=s+1
	\ contains=ALLBUT,pythonFunction,pythonAsync
	\ transparent
endif

syn keyword pythonStatement	False None True
syn keyword pythonStatement	as assert break continue class del exec global
...
if !exists("python_no_exception_highlight")
 " hi def link pythonExceptions		Structure
  hi def link pythonExceptions		Delimiter
endif
if exists("python_space_error_highlight")
...
syn match   pythonUpper   /_\{0,2}\u\(_*\u*\d*\)*\(\u\|\d\)/
syn match   pythonClass   /_\?\u\+\d*\u*\l\+\(\a\|\d\)*/
syn match   pythonPrivate /__\l\(_*\l*\d*\)*\(\l\|\d\)/
syn match   pythonSpecial /__\l\+\d*\l*__/
syn keyword pythonClass   cls self

highlight link pythonOper Macro 
highlight link pythonUpper Todo
highlight link pythonClass Type
highlight link pythonPrivate Underlined
highlight link pythonSpecial Function
